...
const i18n = {
    zh: {
        ...
        audioRecording: {
            ...
            manualModeHint: '使用走带控制播放，点击停止按钮结束录制',
            recordingModeHelpTitle: '📋 录制模式说明：',
            recordingModeAutoHelp: '🔹 <b>自动模式</b>：适用于录制多个音频文件，播放完成后自动开始下一个，可设定最大播放时长',
            recordingModeManualHelp: '🔹 <b>手动模式</b>：需要手动在 Wwise 里面播放，Recorder 插件只会记录最近一次播放结果，需要等待 Wwise 播放完成，再点击停止',
            maxDurationLabel: '最大时长:',
            maxDurationUnit: '秒',
            startBtn: '开始录制',
            stopBtn: '停止',
            stopping: '停止中...',
    ...
    en: {
        ...
        audioRecording: {
            ...
            manualModeHint: 'Use Transport Control to play, click stop to end recording',
            recordingModeHelpTitle: '📋 Recording Mode Guide:',
            recordingModeAutoHelp: '🔹 <b>Auto Mode</b>: For recording multiple audio files, automatically starts the next one after playback, with configurable max duration',
            recordingModeManualHelp: '🔹 <b>Manual Mode</b>: Manually play in Wwise, Recorder plugin only records the latest playback, wait for Wwise playback to complete then click stop',
