...
const i18n = {
    zh: {
        ...
        rtpcManager: {
            ...
            emptyState: '请点击"扫描所有RTPC"按钮',
            scanSuccess: '扫描完成，找到 {count} 个RTPC',
            scanNoResults: '未找到任何RTPC',
            exportSuccess: '导出成功',
            importSuccess: '导入成功，找到 {count} 个需要修改的RTPC',
            importNoChanges: '导入的CSV与当前配置相同，无需修改',
            importError: '导入失败：{error}',
            applySuccess: '成功应用 {count} 个RTPC的修改',
            applyConfirmTitle: '确认应用修改',
            applyConfirmMessage: '确定要应用 {count} 个RTPC的修改吗？',
            alertNotConnected: '请先连接到Wwise',
            alertScanFirst: '请先扫描RTPC，再导入CSV进行对比',
            alertScanFailed: '扫描失败',
            alertApplyFailed: '应用修改失败',
            bindToNone: '无',
            modeNone: 'None',
            modeSlew: 'Slew Rate',
            modeFiltering: 'Filtering'
        },
        audioRecording: {
    ...
    en: {
        ...
        rtpcManager: {
            ...
            applyBtnApplying: 'Applying...',
            resultsTitle: 'RTPC List',
            resultsCount: ' RTPCs',
            clearBtn: 'Clear Results',
            listViewBtn: 'Show in List View',
            tableHeaders: {
            ...
            emptyState: 'Please click "Scan All RTPCs" button',
            scanSuccess: 'Scan completed, found {count} RTPCs',
            scanNoResults: 'No RTPCs found',
            exportSuccess: 'Export successful',
            importSuccess: 'Import successful, found {count} RTPCs to modify',
            importNoChanges: 'Imported CSV matches current configuration, no changes needed',
            importError: 'Import failed: {error}',
            applySuccess: 'Successfully applied changes to {count} RTPCs',
            applyConfirmTitle: 'Confirm Apply Changes',
            applyConfirmMessage: 'Are you sure you want to apply changes to {count} RTPCs?',
            alertNotConnected: 'Please connect to Wwise first',
            alertScanFirst: 'Please scan RTPCs first before importing CSV for comparison',
            alertScanFailed: 'Scan failed',
            alertApplyFailed: 'Failed to apply changes',
            bindToNone: 'None',
            modeNone: 'None',
            modeSlew: 'Slew Rate',
            modeFiltering: 'Filtering'
